/**
 * pace42 Backend Server
 * Handles authentication and routes to agent service
 */
...
const server = http.createServer(async (req, res) => {
  ...
  if (pathname === '/api/v1/auth/validate-garmin' && req.method === 'POST') {
    ...
    if (!garminUsername || !garminPassword) {
      res.writeHead(400);
      res.end(JSON.stringify({ error: 'Garmin username and password required' }));
      return;
    }
  ...
  if (pathname === '/api/v1/chat' && req.method === 'POST') {
    ...
    try {
      const intent = await callAgentService('/classify-intent', 'POST', { message });
...
server.listen(PORT, () => {
  console.log('');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('🏃 pace42 Backend API - Unified');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
