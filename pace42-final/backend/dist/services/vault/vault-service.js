...
class VaultService {
     ...
     */
    async encryptData(plaintext, keyName = 'pace42-data-encryption') {
        try {
            if (!(await this.ensureToken())) {
                return null;
            }
     ...
     */
    async decryptData(ciphertext, keyName = 'pace42-data-encryption') {
        try {
            if (!(await this.ensureToken())) {
                return null;
            }
     ...
     */
    async storeGarminTokens(userId, tokensB64) {
        try {
            if (!(await this.ensureToken())) {
                return false;
            }
     ...
     */
    async deleteGarminTokens(userId) {
        try {
            if (!(await this.ensureToken())) {
                return false;
            }
