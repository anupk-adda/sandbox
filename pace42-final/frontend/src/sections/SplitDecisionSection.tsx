...
export default function SplitDecisionSection() {
    ...
    const ctx = gsap.context(() => {
      ...
      if (headlineRef.current) {
        ...
        scrollTl.fromTo(
          chars,
          { x: '-6vw', opacity: 0 },
          { x: 0, opacity: 1, stagger: 0.01, ease: 'none' },
          0.06
        );
      }
      ...
      scrollTl.fromTo(
        ...
        { x: '-55vw', scale: 0.82, opacity: 0, ease: 'power2.in' },
        0.7
      );
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 text-center px-8">
          ...
          <p
            ref={subheadlineRef}
            className="text-[rgba(244,246,248,0.72)] text-base md:text-lg max-w-md mx-auto"
          >
            Choose the line. We'll keep your pace honest.
          </p>
        </div>
      </div>
      ...
      >
        <div className="micro-label mb-1">DISTANCE</div>
        <div className="metric-value">12.4 km</div>
      </div>
      ...
      >
        ...
        <div className="metric-value">05:38 /km</div>
      </div>
    </section>
  );
}
