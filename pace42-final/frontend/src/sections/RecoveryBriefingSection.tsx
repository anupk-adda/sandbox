...
export default function RecoveryBriefingSection() {
  ...
  return (
    ...
    >
      {/* Background Image */}
      <img
        src="/recovery_bridge_runner.jpg"
        alt="Recovery run"
      ...
      >
        ...
        <div className="relative z-10 text-center px-8">
          ...
          >
            <span className="word inline-block">RECOVERY</span>{' '}
            <span className="word inline-block">BRIEFING</span>
          </h2>
          ...
          <div ref={subheadlineRef} className="text-center">
            <p className="text-[rgba(244,246,248,0.72)] text-base md:text-lg max-w-md mx-auto mb-6">
              Sleep, load, and readiness—translated into tomorrow's pace.
            </p>
      ...
      >
        <div className="micro-label mb-1">SLEEP</div>
        <div className="metric-value">7h 12m</div>
      </div>
      ...
      >
        <div className="micro-label mb-1">READINESS</div>
